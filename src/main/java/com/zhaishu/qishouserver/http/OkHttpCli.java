package com.zhaishu.qishouserver.http;
...
public class OkHttpCli {
    ...
    public String doEnPost(String url, Map<String, String> params) {
        FormBody.Builder builder = new FormBody.Builder();
    ...
    private String enqueue(Request request){
            ...
            public void onFailure(Call call, IOException e) {
                log.info("-------执行请求结果: "+e.toString());
            }

            @Override
            public void onResponse(Call call, Response response) throws IOException {

                log.info("-------执行请求结果: "+response.body().string());
                response.close();
